...
# psql -q -h localhost -p 5432 -d iso19139 -U glosis -f /home/carva014/Work/Code/FAO/GloSIS-private/Metadata/db_model.sql
...
cat /home/carva014/Work/Code/FAO/GloSIS-private/Metadata/data_country.tsv | psql -q -h localhost -p 5432 -d iso19139 -U glosis -c "COPY metadata.country FROM STDIN WITH DELIMITER E'\t'"
cat /home/carva014/Work/Code/FAO/GloSIS-private/Metadata/data_property.tsv | psql -q -h localhost -p 5432 -d iso19139 -U glosis -c "COPY metadata.property(property_id,name,unit_id,min,max,uri,property_type,num_intervals,start_color,end_color) FROM STDIN WITH DELIMITER E'\t' CSV HEADER"
echo 'Adding manual metadata ...'
cat /home/carva014/Work/Code/FAO/GloSIS-private/Metadata/data_PH_metadata.tsv | psql -q -h localhost -p 5432 -d iso19139 -U glosis -c "COPY metadata.metadata_manual FROM STDIN WITH DELIMITER E'\t' CSV HEADER"
...
pg_dump -h localhost -p 5432 -U carva014 -d iso19139 -Fc -v -f /home/carva014/Work/Code/FAO/GloSIS-private/Metadata/backups/iso19139_backup_latest.backup
