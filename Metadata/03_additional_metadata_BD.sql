...
-- dates
UPDATE spatial_metadata.mapset SET creation_date = '2021-11-13', publication_date = '2021-11-13', revision_date = '2021-11-13' WHERE country_id = 'BD' AND project_id = 'GSAS';
UPDATE spatial_metadata.mapset SET creation_date = '2024-12-31', publication_date = '2024-12-31', revision_date = '2024-12-31' WHERE country_id = 'BD' AND project_id = 'GSNM';
UPDATE spatial_metadata.mapset SET creation_date = '2022-04-13', publication_date = '2022-04-13', revision_date = '2022-04-13' WHERE country_id = 'BD' AND project_id = 'GSOCSEQ';
...
-- keywords
UPDATE spatial_metadata.mapset SET keyword_place = '{Vietnam}'::text[] WHERE country_id = 'BD';
...
-- time period
UPDATE spatial_metadata.mapset SET time_period_begin = '1998-01-13' WHERE country_id = 'BD';
UPDATE spatial_metadata.mapset SET time_period_end = '2024-12-13' WHERE country_id = 'BD';
...
INSERT INTO spatial_metadata.proj_x_org_x_ind (country_id, project_id, tag, "role", "position", organisation_id, individual_id)
    SELECT DISTINCT country_id, project_id, 'contact', 'resourceProvider', 'Deputy head', 'Soils and Fertilizers Institute', 'Quyet Manh Vu' FROM spatial_metadata.project WHERE country_id = 'BD'
            UNION
    SELECT DISTINCT country_id, project_id, 'pointOfContact', 'author', 'Deputy head', 'Soils and Fertilizers Institute', 'Quyet Manh Vu' FROM spatial_metadata.project WHERE country_id = 'BD'
            UNION
    SELECT DISTINCT country_id, project_id, 'pointOfContact', 'author', 'Director General', 'Soils and Fertilizers Institute', 'Tien Minh Tran' FROM spatial_metadata.project WHERE country_id = 'BD'
            UNION
    SELECT DISTINCT country_id, project_id, 'pointOfContact', 'author', 'Deputy Director General', 'Soils and Fertilizers Institute', 'Thu Minh Tran' FROM spatial_metadata.project WHERE country_id = 'BD'
            UNION
    SELECT DISTINCT country_id, project_id, 'pointOfContact', 'author', 'Reseacher', 'Soils and Fertilizers Institute', 'Hao Thanh Dang' FROM spatial_metadata.project WHERE country_id = 'BD'
...
INSERT INTO spatial_metadata.url (mapset_id, protocol, url, url_name)
    ...
    SELECT mapset_id, 'OGC:WMTS', 'https://data.apps.fao.org/map/wmts/wmts?service=WMTS&amp;request=GetCapabilities&amp;version=1.0.0&amp;workspace=GLOSIS', 'WMTS (FAO)' FROM spatial_metadata.mapset WHERE country_id = 'BD'
      UNION
    SELECT mapset_id, 'OGC:WMTS', 'http://localhost:8082/?map=/etc/mapserver/'||layer_id||'.map&amp;SERVICE=WMS&amp;REQUEST=GetCapabilities', 'WMTS (Vietnam SIS)' FROM spatial_metadata.layer WHERE layer_id LIKE 'BD-%'
